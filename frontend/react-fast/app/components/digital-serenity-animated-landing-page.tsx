...
const DigitalSerenity: React.FC<DigitalSerenityProps> = ({ username = 'there', hasStartedChat = false }) => {
  ...
  useEffect(() => {
    ...
    if (hour < 12) greetingText = `Good morning, ${username}!`;
    else if (hour < 17) greetingText = `Good afternoon, ${username}!`;
    else if (hour < 21) greetingText = `Good evening, ${username}!`;
    else greetingText = `Good night, ${username}!`;
    
    setGreeting(greetingText);

    // Set dynamic message based on time
    const messages = [
  ...
  useEffect(() => {
    ...
    return () => {
      wordElements.forEach(word => {
        if (word) {
          word.removeEventListener('mouseenter', handleMouseEnter as EventListener);
          word.removeEventListener('mouseleave', handleMouseLeave as EventListener);
        }
      });
    };
  }, []);
        ...
        <div className="relative z-10 min-h-screen flex flex-col justify-between items-center px-6 py-10 sm:px-8 sm:py-12 md:px-16 md:py-20">
          <div className="text-center">
            <h2 className="text-xs sm:text-sm font-mono font-light text-slate-300 uppercase tracking-[0.2em] opacity-80">
              <span className="word-animate" data-delay="0">{greeting}</span>
            </h2>
            ...
            <div className="text-center max-w-5xl mx-auto relative">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extralight leading-tight tracking-tight text-slate-50 text-decoration-animate">
                <div className="mb-4 md:mb-6">
                  <span className="word-animate" data-delay="700">{dynamicMessage}</span>
                </div>
              </h1>
              ...
              <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-thin text-slate-300 leading-relaxed tracking-wide">
                ...
                <span className="word-animate" data-delay="1550">code</span>
                <span className="word-animate" data-delay="1700">meets</span>
                <span className="word-animate" data-delay="1850">creativity</span>
                <span className="word-animate" data-delay="2000">and</span>
                <span className="word-animate" data-delay="2150">ideas</span>
                <span className="word-animate" data-delay="2300">come</span>
                <span className="word-animate" data-delay="2450">to</span>
                <span className="word-animate" data-delay="2600">life.</span>
              </div>
